...
class Trial(object):
    def __init__(self):
        ...
        self.icon_position = [(100, 100), (1300, 100), (100, 800), (1300, 800), (800, 450)]
...
# Time Keeping Funcitons -------------------------------------------------------------------------------------------------
    ...
    def response_time(self):
        ...
        return seconds
# Calibration Phase --- Only runs on trial 1 ----------------------------------------------------------------------------------
    ...
    def run_calibration(self):
        ...
        calibration_points = [(0.2, 0.2), (0.8, 0.8)]
        point_index = 0
        ...
        # PHASE TRANSITION: Paste this block right here
        ...
        # To call the calibration result later, use result.calibration_points
...
# DEFINE THE CURSOR
cursor = Box(color = red, speed = 5, circle = True)


"""CREATE THE DATA FILE-------------------------------------------------------------------------------------------"""
data_file = makeFileName('Fixation_v2')
eye_data_file = makeFileName('Fixation_Eye_Data')
